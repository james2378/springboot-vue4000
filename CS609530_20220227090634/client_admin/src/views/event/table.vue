<template>
	<el-main class="bg">
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="competition_cover" label="比赛封面"
				v-if="user_group == '管理员' || $check_field('get','competition_cover')" min-width="200">
				<template slot-scope="scope">
					<el-image style="width: 100px; height: 100px" :src="$fullUrl(scope.row['competition_cover'])"
						:preview-src-list="[$fullUrl(scope.row['competition_cover'])]">
			...
			<el-table-column prop="competition_introduction" label="比赛简介"
				v-if="user_group == '管理员' || $check_field('get','competition_introduction')" min-width="200">
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/event/table','set') || $check_action('/event/view','set') || $check_action('/event/view','get') || $check_action('/报名/table','add') || $check_action('/报名/view','add')" >
