...
const routes = [
	...
	// 参赛信息路由
	{
		path: '/entry_information/table',
		name: 'entry_information_table',
		component: () => import('../views/entry_information/table.vue')
	},
	{
		path: '/entry_information/view',
		name: 'entry_information_view',
		component: () => import('../views/entry_information/view.vue')
	},
	// 参赛成绩路由
	{
		path: '/entry_results/table',
		name: 'entry_results_table',
		component: () => import('../views/entry_results/table.vue')
	},
	{
		path: '/entry_results/view',
		name: 'entry_results_view',
		component: () => import('../views/entry_results/view.vue')
	},
	// 成绩排名路由
	{
		path: '/score_ranking/table',
		name: 'score_ranking_table',
		component: () => import('../views/score_ranking/table.vue')
	},
	{
		path: '/score_ranking/view',
		name: 'score_ranking_view',
		component: () => import('../views/score_ranking/view.vue')
	},
